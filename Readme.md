...
├── src
│   ├── main
│   │   ├── java\com\account\accountservices
│   │   └── resources
│   └── test
│       ├── java\com\account\accountservices
│       └── resources
...
| POST | /v1/accounts/transfer/from/{fromAccountId}/to/{toAccountId}/amount/{amount} | Transfer amount from fromAccountId to toAccountId |
### Swagger-UI
